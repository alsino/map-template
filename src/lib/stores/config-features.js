export const config = {
	mapTitle: 'test', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'map-test-gamma.vercel.app', // The url provided when deploying the map on Vercel
